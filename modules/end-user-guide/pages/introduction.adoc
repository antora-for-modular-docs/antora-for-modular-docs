...
+
TIP: Don't use the default `ROOT` module name, always use a https://docs.antora.org/antora/3.0/named-module-directory/[Named Module Directory].  
* Optionally, add a new module directory, and create the requested subdirectories. See link:https://docs.antora.org/antora/3.0/standard-directories/[Antora - Standard File and Directory Set]. 
