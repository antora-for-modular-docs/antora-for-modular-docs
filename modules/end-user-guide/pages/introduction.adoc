...
. Create a repository by using link:https://github.com/themr0c/antora-for-modular-docs/generate[the Antora for Modular Docs repository template] and clone the repository to your local environment, or download the https://github.com/themr0c/antora-for-modular-docs/archive/refs/heads/main.zip[Antora for Modular Docs zip archive], decompress it, and use the content of this archive to start a repository.
+
----
...
* A GitHub workflow to publish the docs by using GitHub Pages.
...
+
TIP: Do not use the default `ROOT` module name, always use a https://docs.antora.org/antora/3.0/named-module-directory/[Named Module Directory].  
* Optionally, add a module directory, and create the requested subdirectories. See link:https://docs.antora.org/antora/3.0/standard-directories/[Antora - Standard File and Directory Set]. 


. Edit `antora.yml`. See link:https://docs.antora.org/antora/3.0/component-version-descriptor/[What’s antora.yml?]
+
.`antora.yml`
...
----
<1> Mandatory component `name` with no spaces: results in an URL fragment. See link:https://docs.antora.org/antora/3.0/component-name-and-version/#name-key[Antora - name key]. Example: `docs`.
<2> Optional component title. See link:https://docs.antora.org/antora/3.0/component-title/[Antora - Customize the Title]
<3> Mandatory version name. See link:https://docs.antora.org/antora/3.0/component-name-and-version/#version-key[Antora - version key]. Set to `master` to remove the version from the page URL, see link:https://docs.antora.org/antora/3.0/component-with-no-version/[Antora - Define a Component Version with No Version].
<4> Optional version display name. Example: `Stable`. See link:https://docs.antora.org/antora/3.0/component-display-version/[Antora - Customize the Display Version]
<5> Define the start page. See: link:https://docs.antora.org/antora/3.0/component-start-page/[Antora - Choose a Start Page]
<6> Define navigation file. See: link:https://docs.antora.org/antora/3.0/component-navigation/[Antora - Assign Navigation Files to a Component Version]
...
. Edit `antora-playbook-for-development.yml`. See link:https://docs.antora.org/antora/3.0/playbook/[What’s an Antora playbook?]
+
...
* link:https://docs.antora.org/antora/3.0/[Antora documentation]
* link:https://docs.antora.org/antora/3.0/component-name-and-version/[Define a Component Name and Version]
